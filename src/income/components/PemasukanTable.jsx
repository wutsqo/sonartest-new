...
const PemasukanTable = ({ filterPrograms, incomeListElement
  ...
  const [showModalKonfirmasiHapusPemasukan, setShowModalKonfirmasiHapusPemasukan] = React.useState(false);
  ...
  ,
    	  ...
    	  itemsModals={(pemasukanItem) => [
  	      ...
  	      >
  	       <Link to=''><Button variant="tertiary" onClick={() => setShowModalKonfirmasiHapusPemasukan(false)}>Batal</Button></Link>
  	      <Button
  	        variant="danger"
  	        onClick={() => hapus(pemasukanItem)}
  	      >
  	        Hapus
  	      </Button>
  	      </Modal>
