...
const DetailActivity = ({ data }) => {
    ...
    const [showModalKonfirmasiHapusActivity, setShowModalKonfirmasiHapusActivity] = React.useState(false); 
  ...
  return (
    <Layouts.DetailComponentLayout
      ...
      itemsModals={[
        ...
        >
           <Link to=''><Button variant="tertiary" onClick={() => setShowModalKonfirmasiHapusActivity(false)}>Batal</Button></Link>
          <Button
            variant="danger"
            onClick={() => hapus()}
          >
