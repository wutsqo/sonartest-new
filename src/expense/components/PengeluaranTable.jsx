...
const PengeluaranTable = ({ filterPrograms, expenseListElement
  ...
  const [showModalKonfirmasiHapusPengeluaran, setShowModalKonfirmasiHapusPengeluaran] = React.useState(false);
  ...
  ,
    	  ...
    	  itemsModals={(pengeluaranItem) => [
  	      ...
  	      >
  	       <Link to=''><Button variant="tertiary" onClick={() => setShowModalKonfirmasiHapusPengeluaran(false)}>Batal</Button></Link>
  	      <Button
  	        variant="danger"
  	        onClick={() => hapus(pengeluaranItem)}
  	      >
  	        Hapus
  	      </Button>
  	      </Modal>
